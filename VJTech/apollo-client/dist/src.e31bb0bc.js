 ...
 */
},{"../jsutils/defineInspect":"../node_modules/graphql/jsutils/defineInspect.js"}],"../node_modules/graphql/language/visitor.js":[function(require,module,exports) {
"use strict";
...
var getSoirees = (0, _apolloBoost.gql)(_templateObject2());
client.query({
  query: getUsers
...
client.query({
  ...
  var html = '';
  response.data.soirees.forEach(function (soiree) {
    html += "\n            <div>\n                <h3>".concat(soiree.title, "</h3>\n                <h4>").concat(soiree.author.name, "</h4>\n            </div>\n        ");
  });
